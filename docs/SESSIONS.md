...
| ------------------------------------------------------------------------------------- | ------------------------------------ | --------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| Love Villa: Nations (AI TikTok show: pipeline, dashboard app page, TikTok publishing) | `claude/ai-video-tiktok-app-2e3voe`  | `apps/love-villa/**`, `apps/web/**/love-villa*`, `apps/web/public/love-villa/**`, `packages/shared/src/love-villa.ts` | PAUSED (owner spending freeze) — eps 1-2 on TikTok; V3 directives written (apps/love-villa/docs/DIRECTIVES-V3.md), await owner approval; Creative Director reviewer added |
...
| Mobile & shared UI (responsive shell, branding/icons, video download UX)              | `claude/factory-mobile-redesign-kkq0qa` | `apps/web/src/components/dashboard-shell.tsx` + `logo.tsx` + `media-actions.tsx` + `asset-preview.tsx`, `(dashboard)/layout.tsx`, `(dashboard)/spending/**` + `lib/spending.ts`, app icons/manifest, `scripts/sync-sessions.mjs` | Active — mobile shell, PWA branding, video downloads, Spending page shipped |
